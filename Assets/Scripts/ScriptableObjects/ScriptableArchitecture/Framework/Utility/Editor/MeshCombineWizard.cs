...
public class MeshCombineWizard : ScriptableWizard
{
    ...
    private void OnWizardCreate()
    {
        ...
        // Locals
        Dictionary < Material, List < MeshFilter > > materialToMeshFilterList =
        ...
        foreach ( MeshFilter meshFilter in meshFilters )
        {
            ...
            {
                Debug.LogWarning(
                    "The Mesh Renderer on object " + meshFilter.name + " has no material assigned. Skipping." );
        ...
        foreach ( KeyValuePair < Material, List < MeshFilter > > entry in materialToMeshFilterList )
        {
            ...
            AssetDatabase.CreateAsset(
                combinedMesh,
                "Assets/CombinedMeshesAndPrefabs/CombinedMeshes_" + materialName + ".asset" );
        ...
        // Create prefab
        Object prefab =
            PrefabUtility.CreateEmptyPrefab( "Assets/CombinedMeshesAndPrefabs/" + resultGO.name + ".prefab" );
    ...
    private static void CreateWizard()
    {
        ...
        {
            GameObject firstSelection = selectionObjects[0] as GameObject;
