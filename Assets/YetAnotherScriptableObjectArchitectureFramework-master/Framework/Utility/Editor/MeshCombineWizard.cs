...
public class MeshCombineWizard : ScriptableWizard
{
	...
	void OnWizardCreate()
	{
		...
		foreach (var entry in materialToMeshFilterList) {
			...
			AssetDatabase.CreateAsset(combinedMesh, "Assets/CombinedMeshesAndPrefabs/CombinedMeshes_" + materialName + ".asset");
		...
		// Create prefab
		Object prefab = PrefabUtility.CreateEmptyPrefab("Assets/CombinedMeshesAndPrefabs/" + resultGO.name + ".prefab");
